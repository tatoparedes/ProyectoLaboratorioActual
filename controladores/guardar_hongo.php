...
if (isset($_FILES['mFoto']) && $_FILES['mFoto']['error'] === UPLOAD_ERR_OK) {
    ...
    if (in_array($extension, $allowed)) {
        $mFoto = uniqid("hongo_", true) . "." . $extension;
...
try {
    ...
    // Muestra y Coloración se guardan como texto en microorganismo, pero se registran en constante para futuros autocompletados
